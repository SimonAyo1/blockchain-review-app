...
const Home: React.FC = () => {
  ...
  return (
    <>
          ...
          <div className="row gy-5 gy-lg-0 align-items-center justify-content-between">
            <div className="col-12 col-lg-6">
              <div className="section__content">
                ...
                <p className="section__content-text">
                  Share anonymous company feedback securely using blockchain
                  technology with our app.
                </p>
                <div className="btn-group mt_40">
                  <Link to="/companies" className="btn_theme btn_theme_active">
                    Explore Companies
            ...
            <div className="col-12 col-lg-6 col-xxl-5">
              <div className="hero__thumb">
                <img
                  src="../../../assets/images/Online Review-cuate.svg"
                  alt="Image"
                />
              </div>
            </div>
      ...
      <section className="feature feature--secondary section" id="howitworks">
        <div className="container">
          <div className="row gy-5 gy-lg-0 align-items-center justify-content-between">
            <div className="col-12 col-lg-5 col-xxl-5">
              <div className="section__content">
                ...
                <h2 className="section__content-title">
                  Post Company Reviews Securely on the Blockchain.
                </h2>
                <p className="section__content-content">
                  Explore the future of company reviews with our app. Post
                  anonymously and securely on the blockchain. Your voice
                  matters! Post honest reviews about companies while staying
                  completely anonymous, secured by blockchain technology.
                </p>
                <Link to="/companies" className="btn_theme mt_40">
                  Start Reviewing
                  <i className="bi bi-arrow-up-right"></i>
                  <span></span>
                </Link>
            ...
            <div className="col-12 col-lg-7 col-xxl-5">
              <div className="feature__content gap-4 flex-column ms-lg-4 ms-xxl-0">
                <div className="card card--custom">
                  <div className="card__icon">
                    ...
                    >
                      <g clipPath="url(#clip0_1417_1496)">
                        <path
                  ...
                  <div className="card__content">
                    <div className="card__content-text">
                      <h4 className="card__title">
                        <a> Transparent Feedback</a>
                      </h4>
                      <p className="fs-small">
                        Join a community where your feedback can make a
                        difference. Our platform ensures transparency and
                        integrity in company reviews.
                      </p>
                    </div>
                    <a className="btn_theme social_box">
                ...
                <div className="card card--custom">
                  ...
                  <div className="card__content">
                    <div className="card__content-text">
                      <h4 className="card__title">
                        <a> Anonymous Reviews:</a>
                      </h4>
                      <p className="fs-small">
                        Post honest reviews about companies while staying
                        completely anonymous, secured by blockchain technology.
                      </p>
                    </div>
                    <a className="btn_theme social_box">
                ...
                <div className="card card--custom">
                  ...
                  <div className="card__content">
                    <div className="card__content-text">
                      <h4 className="card__title">
                        <a>Empower Your Voice</a>
                      </h4>
                      <p className="fs-small">
                        Share your experiences working with companies in a
                        secure and meaningful way. Your voice matters, and we
                        provide the platform for it to be heard.
                      </p>
                    </div>
                    <a className="btn_theme social_box">
                      <i className="bi bi-arrow-up-right" />
